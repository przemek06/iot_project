...
class TicketTermChoiceScreen(Screen):
    def __init__(self, parent):
        ...
        menu_option_1 = NewScreenMenuOption("Short term tickets", Screen.get_instance("short_term_tickets_screen"))
        menu_option_2 = NewScreenMenuOption("Long term tickets", Screen.get_instance("long_term_tickets_screen"))
